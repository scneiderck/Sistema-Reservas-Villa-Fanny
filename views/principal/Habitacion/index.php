...
<section class="our-rooms-area pb-100"> 
			...
			<div class="container">
				<div class="section-title">
					...
					<h2>Fasinantes habitaciones</h2>
				</div>
				<div class="row">
					<div class="col-lg-4 col-sm-6">
						<div class="single-rooms-three-wrap">
							<div class="single-rooms-three">
								<img src="<?php echo RUTA_PRIN . 'assets/principal';?>/img/rooms/5.jpg" alt="Image">
					...
					<div class="col-lg-4 col-sm-6">
						<div class="single-rooms-three-wrap">
							<div class="single-rooms-three">
								<img src="<?php echo RUTA_PRIN . 'assets/principal';?>/img/rooms/6.jpg" alt="Image">
								<div class="single-rooms-three-content">
									<h3>Double Room</h3>
									<ul class="rating">
										<li>
					...
					<div class="col-lg-4 col-sm-6">
						<div class="single-rooms-three-wrap">
							<div class="single-rooms-three">
								<img src="<?php echo RUTA_PRIN . 'assets/principal';?>/img/rooms/7.jpg" alt="Image">
								<div class="single-rooms-three-content">
					...
					<div class="col-lg-4 col-sm-6">
						<div class="single-rooms-three-wrap">
							<div class="single-rooms-three">
								<img src="<?php echo RUTA_PRIN . 'assets/principal';?>/img/rooms/8.jpg" alt="Image">
								<div class="single-rooms-three-content">
					...
					<div class="col-lg-4 col-sm-6">
						<div class="single-rooms-three-wrap">
							<div class="single-rooms-three">
								<img src="<?php echo RUTA_PRIN . 'assets/principal';?>/img/rooms/9.jpg" alt="Image">
								<div class="single-rooms-three-content">
					...
					<div class="col-lg-4 col-sm-6">
						<div class="single-rooms-three-wrap">
							<div class="single-rooms-three">
								<img src="<?php echo RUTA_PRIN . 'assets/principal';?>/img/rooms/10.jpg" alt="Image">
								<div class="single-rooms-three-content">
									<h3>Budget Room</h3>
									<ul class="rating">
										<li>
