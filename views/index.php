...
<section class="eorik-slider-area">
    <div class="eorik-slider owl-carousel owl-theme">
        <?php foreach ($data['slider'] as $slider) { ?>
            <div class="eorik-slider-item" style="background-image: url(<?php echo RUTA_PRIN . 'assets/img/sliders/' . $slider['foto'] ?>);">
                <div class="d-table">
    ...
    <div class="white-shape">
        <img src="<?php echo RUTA_PRIN . 'assets/principal'; ?>/img/home-one/slider/white-shape.png" alt="Image">
    </div>
...
<div class="check-area mb-minus-70">
    <div class="container">
        <form class="check-form" id="formulario" action="<?php echo RUTA_PRIN . 'reserva/verify'; ?>">
                    ...
                    <div class="check-content">
                        ...
                        <div class="form-group">
                            <div class="input-group date" id="datetimepicker-1">
                                ...
                                <input type="date" class="form-control" id="f_llegada" name="f_llegada" required>
                    ...
                    <div class="check-content">
                        ...
                        <div class="form-group">
                            <div class="input-group date" id="datetimepicker-2">
                                ...
                                <input type="date" class="form-control" id="f_salida" name="f_salida" required>
                                <span class="input-group-addon">
                                    <i class="glyphicon glyphicon-th"></i>
                                </span>
                            </div>
                ...
                <div class="col-lg-3">
                    <div class="check-content">
                        <div class="form-group">
                            ...
                            <select name="habitacion" class="select-auto" id="habitacion" style="width: 100%;" required>
        ...
        <div class="row align-items-center">
            <div class="col-lg-6">
                <div class="explore-img">
                    <img src="<?php echo RUTA_PRIN . 'assets/principal'; ?>/img/explore-img.png" alt="Image">
                </div>
            </div>
            <div class="col-lg-6">
...
<section class="incredible-area ptb-140 jarallax">
    ...
    <div class="white-shape">
        <img src="<?php echo RUTA_PRIN . 'assets/principal'; ?>/img/shape/white-shape-top.png" alt="Image">
                ...
                <div class="col-lg-4">
                    <ul class="tabs">
                        <li class="single-rooms">
                            <img src="<?php echo RUTA_PRIN . 'assets/principal'; ?>/img/rooms/button-img-1.jpg" alt="Image">
                        ...
                        <li class="single-rooms">
                            <img src="<?php echo RUTA_PRIN . 'assets/principal'; ?>/img/rooms/button-img-2.jpg" alt="Image">
                            <div class="room-content">
                                <h3>Luxury Room</h3>
                        ...
                        <li class="single-rooms">
                            <img src="<?php echo RUTA_PRIN . 'assets/principal'; ?>/img/rooms/button-img-3.jpg" alt="Image">
                            <div class="room-content">
                                <h3>Best Room</h3>
                        ...
                        <li class="single-rooms">
                            <img src="<?php echo RUTA_PRIN . 'assets/principal'; ?>/img/rooms/button-img-4.jpg" alt="Image">
                            <div class="room-content">
                                <h3>Classic Room</h3>
                        ...
                        <li class="single-rooms">
                            <img src="<?php echo RUTA_PRIN . 'assets/principal'; ?>/img/rooms/button-img-5.jpg" alt="Image">
                            <div class="room-content">
                                <h3>Budget Room</h3>
                                <span>From $95.9/night</span>
                            </div>
        ...
        <div class="testimonials-wrap owl-carousel owl-theme">
            <div class="single-testimonials">
                ...
                <div class="testimonials-content">
                    <img src="<?php echo RUTA_PRIN . 'assets/principal'; ?>/img/testimonials/2.jpg" alt="Image">
                    <h4>Ayman Jenis</h4>
            ...
            <div class="single-testimonials">
                ...
                <p>“Awesome yksum dolor sit ametco elit, sed do eiusmod tempor incididunt et md do eiusmoeiusmod tempor inte emamnsecacing eiusmoeiusmod”</p>
                <div class="testimonials-content">
                    <img src="<?php echo RUTA_PRIN . 'assets/principal'; ?>/img/testimonials/3.jpg" alt="Image">
                    <h4>Ayman Jenis</h4>
                    <span>CEO@Leasuely</span>
                </div>
            </div>
            <div class="single-testimonials">
                ...
                <p>“Awesome yksum dolor sit ametco elit, sed do eiusmod tempor incididunt et md do eiusmoeiusmod tempor inte emamnsecacing eiusmoeiusmod”</p>
                <div class="testimonials-content">
                    <img src="<?php echo RUTA_PRIN . 'assets/principal'; ?>/img/testimonials/1.jpg" alt="Image">
                    <h4>Ayman Jenis</h4>
                    <span>CEO@Leasuely</span>
                </div>
            </div>
        ...
        <div class="row">
                ...
                <div class="single-news">
                    <div class="news-img">
                        <a href="news-details.html">
                            <img src="<?php echo RUTA_PRIN . 'assets/principal'; ?>/img/news/1.jpg" alt="Image">
                        </a>
                        <div class="dates">
                            <span>HOTEL</span>
                        </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single-news">
                    <div class="news-img">
                        <a href="news-details.html">
                            <img src="<?php echo RUTA_PRIN . 'assets/principal'; ?>/img/news/2.jpg" alt="Image">
                        </a>
                        <div class="dates">
                            <span>PRICE</span>
                        </div>
...
<script src="<?php echo RUTA_PRIN . 'assets/principal/js/pages/index.js'; ?>"></script>
